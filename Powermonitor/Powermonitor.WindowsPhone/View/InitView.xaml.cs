...
namespace Powermonitor.View
{
    ...
    /// </summary>
    public sealed partial class InitView : Page
    {
        ...
        public InitView()
        {
            ...
            Messenger.Default.Register<string>(this, SocketError);
        }

        async private void SocketError(string msg)
        {
            errorMsg.Text = msg;
        ...
        {
            await (DataContext as InitViewModel).Init();
        }
    }
}
