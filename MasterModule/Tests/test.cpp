...
// Last update Tue Aug 25 00:12:47 2015 alexis mestag
//
...
int			main() {
  ...
  Repository<GlobalReading>::query_type	q(Repository<GlobalReading>::query_type::info.unit == 2 &&
					  Repository<GlobalReading>::query_type::tp.point == 1436299435);
